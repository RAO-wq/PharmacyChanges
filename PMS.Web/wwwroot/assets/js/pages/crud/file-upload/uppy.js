...
var KTUppy = function () {
	...
	var initUppy1 = function(){
		...
		uppyDashboard.use(Tus, { endpoint: '' });
	...
	return {
		...
		init: function() {
			...
			setTimeout(function() {
				swal.fire({
					"title": "Notice",
					"html": "Uppy demos uses URL for resumable upload examples and your uploaded files will be temporarely stored in <b>tus.io</b> servers.",
					"type": "info",
