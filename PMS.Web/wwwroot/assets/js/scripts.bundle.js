...
(function($) {
	...
	$.fn[pluginName].defaults = {
		...
		translate: {
			records: {
                processing: localStorage.getItem('languageId') == 0 ? 'Please wait...' : 'انتظر من فضلك...',
                noRecords: localStorage.getItem('languageId') == 0 ? 'No records found' : 'لا توجد سجلات',
			},
			toolbar: {
				pagination: {
					items: {
                        ...
                        info: localStorage.getItem('languageId') == 0 ? 'Showing {{start}} - {{end}} of {{total}}' : 'عرض {{start}} - {{end}} من {{total}}',
					},
				},
			},
		},
